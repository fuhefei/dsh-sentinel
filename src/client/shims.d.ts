...
declare module 'cordis' {
  export interface Context {
    ...
    slots: {
      ...
      register(row: { name: string; id?: string; key?: string; order?: number; locale?: string }, component: unknown): unknown
    }
  }
}
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  export type PropsRuntime<Name extends string> = {
    ...
    /** Keyed session-scope holes (e.g. the sessionRow branch) pass the key directly. */
    sessionId: string
  } & { __slot?: Name }
